...
public class CUstomExpandableOpenWorkAdapter extends BaseExpandableListAdapter {
    ...
    public CUstomExpandableOpenWorkAdapter(SelectBookingSpace selectBookingMettingSpace, List<NewBaysItem> rooms) {
